import java.util.*;
import java.io.*;
public class organize3009kclusters {
	public static void main(String[] args) throws Exception {
		...
		System.out.println("--------------------------------------------------------------------");
		int count = 0;
		PrintWriter centers = new PrintWriter(new File("./ordered3009kclusters/centers.txt"));
		for (int i = 0; i < 60; i++) {
			Scanner ord = new Scanner(new File("./center3009kclusters/clust_" + i + ".txt"));
			while (ord.hasNext()) {
				...
				Scanner clust = new Scanner(new File("./3009knumclusters/clust_" + j + ".txt"));
				PrintWriter out = new PrintWriter(new File("./ordered3009kclusters/clust_" + count + ".txt"));
